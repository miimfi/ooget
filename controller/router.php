...
if($AuthResult || $request['mode']=='ForgotPasswordUpdate' ||$request['mode']=='ForgotPassword' || $request['mode']=='CreateEmployer' || $request['mode']=='Login' || $request['mode']=='CreateJobseeker' || $request['mode']=='CheckCompanyUenExist' || $request['mode']=='CheckEmail' || $request['mode']=='CheckUnique')
{
  $Modules;
  if($request['module'])
  {
